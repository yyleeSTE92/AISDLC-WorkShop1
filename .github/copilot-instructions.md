# GitHub Copilot instructions — Snip repo conventions
# Mirror: CLAUDE.md at repo root — keep both files in sync when editing either one.

## What this repo is

**Snip** is a tiny URL shortener built as a *superproject* (`main` branch) that wires
